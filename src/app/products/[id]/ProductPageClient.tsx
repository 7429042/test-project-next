...
export default function ProductPageClient({id}: { id: string }) {
    ...
    const {data, isLoading, error} = useGetProductByIdQuery(id, {skip: Boolean(localProduct)});

    const product: IProduct | undefined = useMemo(() => localProduct ?? (data as IProduct | undefined), [localProduct, data]);
