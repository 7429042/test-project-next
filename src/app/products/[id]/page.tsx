        ...
        <div className="flex flex-col p-6">
            ...
            {isFavFilter && isEmpty ? (
                <div className="flex flex-col items-center justify-center py-20 text-center gap-2">
                    ...
                    <p className="text-default-500 max-w-md">Отметьте товары сердечком, чтобы они появились в этом
                        списке.</p>
                ...
                <div className="w-full max-w-screen-xl mx-auto">
                    <div
                        ...
                        {pageItems.map((product: IProduct) => {
                            const id = product.id; // по типам это число
                            const isApiNumeric = Number.isInteger(id) && id > 0;
